        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4">
            <b-form-group
              ...
              label="Title:"
              label-for="title"
              description="Please enter a appropriate title for your instruction guide"
            >
              ...
              <b-form-input
                ...
                v-model="$v.instructionGuide.title.$model"
                :state="
                  $v.instructionGuide.title.$dirty
                    ? !$v.instructionGuide.title.$error
                    : null
                "
            ...
            >
              <b-form-input
                ...
                v-model="$v.instructionGuide.author.$model"
                :state="
                  $v.instructionGuide.author.$dirty
                    ? !$v.instructionGuide.author.$error
                    : null
                "
            ...
            <b-form-group
              ...
              label="Category:"
              label-for="category"
              description="Please enter a appropriate category"
            >
              <b-form-input
                id="category"
                type="text"
                ...
                v-model="$v.instructionGuide.category.$model"
                :state="
                  $v.instructionGuide.category.$dirty
                    ? !$v.instructionGuide.category.$error
                    : null
                "
            ...
            >
              <b-form-input
                ...
                v-model="$v.instructionGuide.image.$model"
                :state="
                  $v.instructionGuide.image.$dirty
                    ? !$v.instructionGuide.image.$error
                    : null
                "
            ...
            >
              <b-form-input
                ...
                v-model="$v.instructionGuide.youtubeId.$model"
                :state="
                  $v.instructionGuide.youtubeId.$dirty
                    ? !$v.instructionGuide.youtubeId.$error
                    : null
                "
          ...
          <div class="col-12 col-md-8">
            <b-form-group
              ...
              label-for="equipment"
              description="Please enter all required equipment"
            >
              <b-form-textarea
                id="equipment"
                ...
                rows="3"
                max-rows="6"
                v-model="$v.instructionGuide.equipment.$model"
                :state="
                  $v.instructionGuide.equipment.$dirty
                    ? !$v.instructionGuide.equipment.$error
                    : null
                "
            ...
            <b-form-group
              ...
              description="Please enter all required instructions"
            >
              <b-form-textarea
                id="instructions"
                ...
                rows="12"
                max-rows="50"
                v-model="$v.instructionGuide.instructions.$model"
                :state="
                  $v.instructionGuide.instructions.$dirty
                    ? !$v.instructionGuide.instructions.$error
                    : null
                "
          ...
          <div class="col-12">
            <b-button @click="create" class="w-100" variant="primary"
              >Submit</b-button
            >
          </div>
        </div>
